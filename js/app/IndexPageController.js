...
myapp.pages.IndexPageController = function(myapp, $$) {
	...
	(function() {
		var options = {
			...
			welcomescreen_slides = [{
				...
				},
				{
					...
					// title: 'NO TITLE', 
					picture: '<div class="tutorialicon">☆</div>',
					text: 'Thanks for reading! Enjoy this app or go to <a class="tutorial-previous-slide" href="#">previous slide</a>.<br><br><a class="tutorial-close-btn" href="#">开始使用</a>'
				}
			],
		...
		$$(document).on('click', '.tutorial-close-btn', function() {
			...
			map["key"] = "isLogin";
			map["value"] = "1";
			SogreyWebsql.insert("keyValue", map) //点击了开始使用，设置引导页已阅读
		});
